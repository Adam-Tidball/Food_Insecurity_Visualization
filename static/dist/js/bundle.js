// console.log("Hello from vizbody.js");
// console.log(d3);
...
//         .append("p")
//         .text(function(d) {
//             if (d.Year === "2020" && d.Geography === "British Columbia") {
//                 return "Food Secuirty Status" + d["Household food security status"] + ". Percentage of population: " + d["Percent of all population"] + "%";
//             }
//         });
// });
// console.log(d3);
var my_DATA = await d3.csv("/data/Health_Characteristics_diabetes.csv");
...
// function dataAt(year, ratio) {
//     return my_DATA.map(d => ({
//         Geography: d.Geography,
//         Diabetes: valueAt(d.income, year, ratio),
//       }));
// };

// function valueAt (values, year, ratio){
...
d3.csv("/data/Health_Characteristics.csv").then(function(data) {       
    ...
    provinces_selected = JSON.parse(sessionStorage.getItem('selectedProvinces')) || [];
    ...
    characteristics_selected = JSON.parse(sessionStorage.getItem('selectedCharacteristics')) || [];
...
function updateChart(newData) {
    // Clear existing chart elements that need to be re-drawn
    svg.selectAll("*").remove();

    // Assuming newData is the filtered dataset based on the selections
    // Redraw the chart using newData similar to how the chart is initially drawn
    // This involves setting up the scales, axes, and plotting the data points again

    // Example: Re-plotting data points (you'll need to adjust this based on your actual chart setup)
    svg.selectAll("circle")
        .data(newData)
        .enter()
        .append("circle")
        .attr("cx", function(d) { return x(d.Year); })
        .attr("cy", function(d) { return y(d.Value); }) // Assuming 'Value' is a property in your data
        .attr("r", 5)
        .style("fill", function(d) { return color(d.Characteristics); });
}